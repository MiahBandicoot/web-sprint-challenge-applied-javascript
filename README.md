...
1. What is the DOM?
    Dom is the object oriented visual of a webpage html.

2. What is an event?
    Any action that takes place within the webpage.

3. What is an event listener?
    What detects any event that occurs.

4. Why would we convert a NodeList into an Array?
    NodeList does not use most array methods.

5. What is a component?
    Independent and reusable code that returns html.
